...
const ocws_shell_entry_t OCWS_SHELLS[] = {
    { "OCWS Double Panel", "doublepanel",
      "Default OCWS — dual panel\nzigshell-cairo-pango desktop",
      "preferences-desktop-display" },
    { "Zigshell-cairo-pango",      "zigshell-cairo-pango",
      "ZIGSHELL-CAIRO-PANGO + macOS-style dock\nSmooth animations",
      "preferences-desktop-wallpaper" },
    { "Minimal",           "minimal",
      "Minimal zigshell-cairo-pango (clock,\nvolume, battery, tray)",
      "preferences-system" },
    { "Two Row",           "tworow",
      "LXQt bottom panel +\nzigshell-cairo-pango 2-row taskbar",
      "preferences-desktop" },
    ...
    { "LXQt Classic",      "lxqt-classic",
      "LXQt bottom panel +\nzigshell-cairo-pango top status",
      "preferences-desktop" },
    { "LXQt Minimal",      "lxqt-minimal",
      "LXQt top tray/clock +\nzigshell-cairo-pango minimal",
      "preferences-system" },
    { "LXQt Standalone",   "lxqt-standalone",
      "LXQt panel only\n(no zigshell-cairo-pango)",
      "preferences-desktop" },
    { "LXQt Dual Panel",   "lxqt-dual-lxqt",
      "Dual LXQt panels\n(top + bottom, no zigshell-cairo-pango)",
      "preferences-desktop" },
    { "LXQt Vertical",     "lxqt-vertical",
      "LXQt right vertical\npanel + zigshell-cairo-pango top",
      "preferences-desktop" },
